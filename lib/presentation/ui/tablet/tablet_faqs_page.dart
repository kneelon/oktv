...
class TabletFaqsPage extends StatefulWidget {
  const TabletFaqsPage({super.key});

  @override
  State<TabletFaqsPage> createState() => _TabletFaqsPageState();
}

class _TabletFaqsPageState extends State<TabletFaqsPage> {
